...
AccelStepper plateDriver(4,42,43,44,45); // "1" specifys mode of, step, direction
int MS1 = 24;
int MS2 = 25;
int SLEEP = 26;
AccelStepper pump(1, 22,23); // "4" specifys bipolar w the 4 pins following
...
void setup(){
  ...
  pump.setMaxSpeed(1000.0);
  pump.setAcceleration(500.0);
  //pump.moveTo(10000);
}
